...
echo "================================================================="
echo "$blue \e[0m WordPress Installer (Because We Are Lazy)"
echo "================================================================="
print_error () {
...
# if [ -d "./vendor" ];
#     then
#         print_info "/vendor folder found, updating packages..."
#         composer update
#     else
...
echo "You can go ahead and check your website at $SITE_URL"
echo ""
